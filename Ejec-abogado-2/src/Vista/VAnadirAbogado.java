 ...
 * @author 1gdaw06
 */
public class VAnadirAbogado extends javax.swing.JDialog {

    /**
     * Creates new form VAnadirAbogado
     */
    public VAnadirAbogado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dar de alta ABOGADOS");
    ...
    private void banadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banadirActionPerformed
        try {
            //validaciones
            if(Controlador.Controlador.insertarAbogado(tfdni.getText(), tfnombre.getText(), tfapellidos.getText(), tfdir.getText())){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAnadirAbogado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VAnadirAbogado dialog = new VAnadirAbogado(new javax.swing.JFrame(), true);
